<script>
  ...
  import _ProductView from "./routes/_ProductView.svelte";
...
<div class="[ body-wrapper ]">
  ...
  <main
    class="[ main-container ] [ gap-2 padding-1 border-radius-cubed margin-block-end-auto ]"
  >
    <Router {routes} />
  </main>
