...
import { P as Product, C as ComponentMap } from "../../_app/immutable/chunks/ComponentMap-683aba7d.js";
import { F as FlexyCustom, T as TypoHeader, C as Card, b as Typography } from "../../_app/immutable/chunks/Card-90c09661.js";
import { w as writable, m as mq, B as Button, I as Icon, c as TRASH_ICON } from "../../_app/immutable/chunks/consts-bb46f5e3.js";
  ...
  return `${validate_component(FlexyCustom, "FlexyCustom").$$render(
    ...
    {},
    {
      default: () => {
		...
		<div class="${"[ products cart__products ] [ grid gap-2 margin-block-end-2 ]"}"${add_attribute("data-mode", $mq.state === 2 ? "mobile" : "desktop", 0)}>${$cart.items.length > 0 ? `${each($cart.items, (productData) => {
          return `${validate_component(FlexyCustom, "FlexyCustom").$$render($$result, { collapseOnMobile: true, align: "start" }, {}, {
            default: () => {
              return `${validate_component(Product, "Product").$$render($$result, { props: { ...productData.product } }, {}, {})}
